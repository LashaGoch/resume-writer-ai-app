...
def process_resume():
    ...
    tasks = [
        ...
        Task(
            ...
            "Make title **Summary**. This consists of exactly **3 concise paragraphs**, each no more than 2 lines. Use clear, impactful language."
        ...
        Task(
            ...
            "Make title **Areas of Expertise**. This section is a grid with **9 keywords**, arranged in **3 columns and 3 rows**, center-aligned or evenly spaced."
        ),
        Task(
            ...
            "Make title **Notable Achievements**. This section is 3–5 bullet points describing notable achievements.\n" 
            "Each bullet must be measurable and max 2 lines.\n"
        ...
        Task(
            ...
            "Make title **Professional Experience**.\n"
        ...
        Task(
            ...
            expected_output="Older jobs in 2-line format (company + role + dates).\n"
             "Make title **Additional Experience**. Additional experiences must be formatted in two lines per role:\n"
        ...
        Task(
            ...
            expected_output= "Make title **Education**:\n"
        ...
        Task(
            ...
            agent=cert_writer,
            expected_output= "Make title **Certifications**:\n"
        ...
        Task(
            ...
            expected_output="**Languages** should be listed in one single line, near the bottom. Start with Languages:"
        )
